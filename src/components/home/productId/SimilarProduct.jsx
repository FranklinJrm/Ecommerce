...
const SimilarProduct = ({product}) => {
    ...
    useEffect(() => {
      const URL = "https://e-commerce-api-v2.academlo.tech/api/v1/products/categories"
      axios.get(URL)
    ...
    useEffect(() => {
      if(idCategory){
        const URL = `https://e-commerce-api-v2.academlo.tech/api/v1/products?category=${idCategory}`
        axios.get(URL)
